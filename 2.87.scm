...
(define p1 (make-polynomial 'x (list (list n2 n1) (list n1 n1))))
(define p2 (make-polynomial 'x (list (list n3 n0) (list n0 n2))))
(define p3 (make-polynomial 'x (list (list n3 n0) (list n2 n0))))
