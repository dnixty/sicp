(define (count-change amount kind-of-coins)
...
;; The order of the list `coins-values' does not affect the answer
;; because the procedure computes all possible combinations.
