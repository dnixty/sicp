...
(define r1 (make-rational 0 4))
(define r2 (make-rational 3 0))
(define r3 (make-rational 1 1))
(=zero? r1)
(=zero? r2)
(=zero? r3)

(define z1 (make-complex-from-real-imag 0 4))
...
(define z4 (make-complex-from-mag-ang 0 4))
(define z5 (make-complex-from-mag-ang 0 0))
(define z6 (make-complex-from-mag-ang 1 2))
(=zero? z4)
(=zero? z5)
(=zero? z6)
